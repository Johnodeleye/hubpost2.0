...
const SigninBtns = () => {
    return (
        <div className="mt-4 p-4 flex flex-col items-center justify-center gap-4 lg:mt-4">
          ...
          <div>
            <button className=" mt-4 flex items-center border p-3 px-5 py-2 rounded-full gap-2 border-green-400 hover:bg-green-400 transition">
                <span>
            ...
            <button className=" flex items-center border p-3 px-6 mt-7 rounded-full gap-4 py-4 border-green-400 hover:bg-green-400 transition">
                <span>
